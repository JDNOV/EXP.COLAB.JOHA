...
PARAM  <- list()
PARAM$experimento <- "DTJ2-TS6410"

PARAM$exp_input  <- "DTJ2-FE6310"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future       <- c( 202106 )
PARAM$final_train  <- c( 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009 )

PARAM$train$training     <- c( 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007)
